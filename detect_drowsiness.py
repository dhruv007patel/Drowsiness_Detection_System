...
""" define two constants, one for the eye aspect ratio to indicate blink and 
	then a second constant for the number of consecutive 
...
print("Loading shape_predictor to detect eyes...")
# detecting face from the image 
detector = dlib.get_frontal_face_detector()
#detecting eyes from face
...
while True:
	...
	for rect in rects:
		# determine the facial landmarks for the face region, then convert the facial landmark (x, y)-coordinates to a array
